...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div id="section4" class="container-fluid bg-warning"
		...
		<div class="text-center p-3 bg-secondary text-white">
			<h4>4. Servlet to servlet calling using The sendRedirect()
				method of HttpServletResponse interface & url rewriting concept</h4>
		</div>
		<br>
	...
	<div id="section7" class="container-fluid bg-info"
		...
		<br>
		<form action="servletCall7" method="post">
			<input type="text" class="form-control" placeholder="Enter User Name"
					name="userName">
			<input type="hidden" name="userId" value=442>
			<br> <input type="Submit" class="btn btn-primary" value="Submit">
			<br><i>url rewriting used in <b>SendRedirect Section</b> CLASS Name: DemoServlet4 Line no.: 24</i>
			<br><i>HttpSession used in <b>Attribute Section</b> CLASS Name: ServletCall6 Line no.: 33</i>
		</form>
